  ...
  return (
    <div className={`${inter.className} bg-white h-screen flex flex-row overflow-hidden relative`}>
      ...
      <div className='w-[60%] bg-white h-full flex flex-col items-center justify-center px-12 relative z-20'>
        ...
        <p className='text-gray-500 text-sm mb-8'>Enter the verification code sent to your phone number</p>
        ...
        <form onSubmit={handleSubmit} className='space-y-6 w-full max-w-md'>
          ...
          <div className='text-center'>
            ...
            >
              Didn&apos;t receive code? <span className='font-semibold text-blue-600 hover:cursor-pointer'>Resend</span>
            </button>
          </div>
