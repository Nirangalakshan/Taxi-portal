      ...
      >
        ...
        <form className="space-y-5 w-full max-w-md">
          ...
          >
            ...
            <div className="relative">
              ...
              <select
                ...
                onChange={(e) =>
                  setRecoveryMethod(e.target.value as "phone" | "email")
                }
          ...
          <motion.button
            ...
            className="w-full bg-linear-to-r from-[#4A90E2] to-[#2563EB] text-white font-semibold py-3 rounded-xl hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform"
          >
